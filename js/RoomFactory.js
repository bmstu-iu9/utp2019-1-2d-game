...
class RoomFactory {
    ...
    static CreateRoundedRoom(object = undefined) {
        ...
        if (object === undefined) {
            ...
            room.drawRandomDirtGrassB(86, 38, 12, 0)
            ...
            room.drawRandomDirtGrassB(86, 48, 12, 0)
            room.drawDirt(82, 49, 16, 2)
            ...
            room.Add(TilesFactory.CreateTrap3(48, 18))
            room.Add(TilesFactory.CreateTrap5(44.4, 18))
