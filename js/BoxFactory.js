...
class BoxFactory {
    ...
    static CreateKnightBox() {
        let data = [new SpritePattern("knight_idle", imagesStorage.knight, [0, 1, 2, 3], "horizontal", 0, 0, 84, 84, false, 1),
            ...
            new SpritePattern("knight_run_left", imagesStorage.knight, [1, 2, 4, 5], "horizontal", 0, 2, 84, 84, false, 7),
            new SpritePattern("knight_run_right", imagesStorage.knight, [1, 2, 4, 5], "horizontal", 0, 3, 84, 84, false, 7)]
        let result = new SpriteBox()
        data.forEach((u) => {
            result.add(u)
        })
